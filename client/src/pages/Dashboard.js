...
export default function Dashboard() {
  ...
  const charges = todaysTransactions.filter(transaction => transaction.type === 'charge');
  const payouts = todaysTransactions.filter(transaction => transaction.type === 'payout');
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={8} lg={9}>
                ...
                >
                <Chart transactions={chargeTrends} isLoading={isLoading} error={error} />
                </Paper>
              </Grid>
              {/* Recent Deposits */}
